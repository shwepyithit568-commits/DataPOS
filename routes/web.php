...
Route::prefix('store/{store_slug}')
    ...
    ->group(function () {
        ...
        Route::post('/admin/settings', [StoreSettingController::class, 'update'])->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
        Route::post('/admin/settings/appearance/revisions/{revision}/rollback', [StoreSettingController::class, 'rollbackTheme'])
            ...
            ->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
        ...
        Route::middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit'])->group(function () {
        ...
        Route::post('/admin/settings/payment-methods', [StoreSettingController::class, 'storePaymentMethod'])->name('store.admin.settings.payment-methods.store')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
        Route::put('/admin/settings/payment-methods/{method}', [StoreSettingController::class, 'updatePaymentMethod'])->name('store.admin.settings.payment-methods.update')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
        Route::delete('/admin/settings/payment-methods/{method}', [StoreSettingController::class, 'destroyPaymentMethod'])->name('store.admin.settings.payment-methods.destroy')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
        Route::post('/admin/settings/delivery-methods', [StoreSettingController::class, 'storeDeliveryMethod'])->name('store.admin.settings.delivery-methods.store')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
        Route::put('/admin/settings/delivery-methods/{method}', [StoreSettingController::class, 'updateDeliveryMethod'])->name('store.admin.settings.delivery-methods.update')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
        Route::delete('/admin/settings/delivery-methods/{method}', [StoreSettingController::class, 'destroyDeliveryMethod'])->name('store.admin.settings.delivery-methods.destroy')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
        ...
        Route::middleware(EnsureStoreAccess::class . ':store_manager')->group(function () {
            ...
            Route::get('/admin/navigation/create', [StorefrontNavigationController::class, 'create'])->name('store.admin.navigation.create')->middleware('store.permission:navigation.edit');
            Route::post('/admin/navigation', [StorefrontNavigationController::class, 'store'])->name('store.admin.navigation.store')->middleware('store.permission:navigation.edit');
            Route::get('/admin/navigation/{id}/edit', [StorefrontNavigationController::class, 'edit'])->name('store.admin.navigation.edit')->middleware('store.permission:navigation.edit');
            Route::put('/admin/navigation/{id}', [StorefrontNavigationController::class, 'update'])->name('store.admin.navigation.update')->middleware('store.permission:navigation.edit');
            Route::delete('/admin/navigation/{id}', [StorefrontNavigationController::class, 'destroy'])->name('store.admin.navigation.destroy')->middleware('store.permission:navigation.edit');
            Route::post('/admin/navigation/{id}/reorder/{direction}', [StorefrontNavigationController::class, 'reorder'])->name('store.admin.navigation.reorder')->whereIn('direction', ['up', 'down'])->middleware('store.permission:navigation.edit');
            Route::post('/admin/navigation/{id}/toggle', [StorefrontNavigationController::class, 'toggleStatus'])->name('store.admin.navigation.toggle')->middleware('store.permission:navigation.edit');
            Route::post('/admin/navigation/reset-defaults', [StorefrontNavigationController::class, 'resetDefaults'])->name('store.admin.navigation.reset_defaults')->middleware('store.permission:navigation.edit');
            Route::get('/admin/navigation/export/{format}', [StorefrontNavigationController::class, 'export'])->name('store.admin.navigation.export')->whereIn('format', ['xlsx', 'csv'])->middleware('store.permission:navigation.view');
        });
        ...
        Route::middleware(EnsureStoreAccess::class . ':store_manager,staff')->group(function () {
            ...
            Route::get('/admin/pages/create', [StorefrontPageController::class, 'create'])->name('store.admin.pages.create')->middleware('store.permission:pages.edit');
            Route::post('/admin/pages', [StorefrontPageController::class, 'store'])->name('store.admin.pages.store')->middleware('store.permission:pages.edit');
            Route::get('/admin/pages/{id}/edit', [StorefrontPageController::class, 'edit'])->name('store.admin.pages.edit')->middleware('store.permission:pages.edit');
            Route::put('/admin/pages/{id}', [StorefrontPageController::class, 'update'])->name('store.admin.pages.update')->middleware('store.permission:pages.edit');
            Route::delete('/admin/pages/{id}', [StorefrontPageController::class, 'destroy'])->name('store.admin.pages.destroy')->middleware('store.permission:pages.edit');
            Route::post('/admin/pages/{id}/toggle', [StorefrontPageController::class, 'toggleStatus'])->name('store.admin.pages.toggle')->middleware('store.permission:pages.edit');
            Route::get('/admin/pages/export/{format}', [StorefrontPageController::class, 'export'])->name('store.admin.pages.export')->whereIn('format', ['xlsx', 'csv'])->middleware('store.permission:pages.view');
        });
        ...
        Route::middleware(['store.capability:storefront.blog', 'store.channel:online_store'])->group(function () {
            ...
            Route::get('/admin/blog/create', [AdminBlogController::class, 'create'])->name('store.admin.blog.create')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:blog.edit']);
            Route::post('/admin/blog', [AdminBlogController::class, 'store'])->name('store.admin.blog.store')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:blog.edit']);
            Route::get('/admin/blog/{post}/edit', [AdminBlogController::class, 'edit'])->name('store.admin.blog.edit')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:blog.edit']);
            Route::put('/admin/blog/{post}', [AdminBlogController::class, 'update'])->name('store.admin.blog.update')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:blog.edit']);
        ...
        Route::post('/admin/customers', [CustomerDirectoryController::class, 'store'])->name('store.admin.customers.store')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:customers.edit']);
        Route::get('/admin/customers/export', [CustomerDirectoryController::class, 'exportCsv'])->name('store.admin.customers.export')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:customers.view']);
        ...
        Route::put('/admin/customers/{customer}', [CustomerDirectoryController::class, 'update'])->name('store.admin.customers.update')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:customers.edit']);
        ...
        Route::middleware('store.capability:commerce.customer_debt')->group(function () {
            ...
            Route::post('/admin/receivables/{customer}/collect', [\App\Http\Controllers\Admin\CustomerReceivableController::class, 'collect'])->name('store.admin.receivables.collect')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'finance_access', 'store.permission:receivables.edit']);
        ...
        Route::get('/admin/profit-loss/export', [\App\Http\Controllers\Admin\ProfitLossController::class, 'export'])->name('store.admin.profit_loss.export')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'finance_access', 'store.permission:profit_loss.view']);
        ...
        Route::middleware('store.capability:service.repair_jobs')->group(function () {
            ...
            Route::get('/admin/repairs/create', [RepairController::class, 'create'])->name('store.admin.repairs.create')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:repairs.edit']);
            Route::post('/admin/repairs', [RepairController::class, 'store'])->name('store.admin.repairs.store')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:repairs.edit']);
            ...
            Route::get('/admin/repairs/{repair}/edit', [RepairController::class, 'edit'])->name('store.admin.repairs.edit')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:repairs.edit']);
            Route::put('/admin/repairs/{repair}', [RepairController::class, 'update'])->name('store.admin.repairs.update')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:repairs.edit']);
            Route::post('/admin/repairs/{repair}/status', [RepairController::class, 'updateStatus'])->name('store.admin.repairs.status')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:repairs.edit']);
            Route::post('/admin/repairs/quick-add-technician', [RepairController::class, 'quickAddTechnician'])->name('store.admin.repairs.quick_add_technician')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:repairs.edit']);
            Route::post('/admin/repairs/{repair}/payments', [RepairController::class, 'addPayment'])->name('store.admin.repairs.payments.store')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:repairs.edit']);
            Route::post('/admin/repairs/{repair}/items/{item}/deduct', [RepairController::class, 'deductItem'])->name('store.admin.repairs.items.deduct')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:repairs.edit']);
            ...
            Route::post('/admin/service-settings/import', [ServiceSettingController::class, 'import'])->name('store.admin.service_settings.import')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:service_settings.edit']);
            ...
            Route::post('/admin/service-settings', [ServiceSettingController::class, 'store'])->name('store.admin.service_settings.store')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:service_settings.edit']);
            Route::post('/admin/service-settings/quick-add', [ServiceSettingController::class, 'quickAdd'])->name('store.admin.service_settings.quick_add')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:service_settings.edit']);
            Route::put('/admin/service-settings/{service_setting}', [ServiceSettingController::class, 'update'])->name('store.admin.service_settings.update')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:service_settings.edit']);
            ...
            Route::post('/admin/spare-parts/{item}/deduct', [SparePartController::class, 'deductItem'])->name('store.admin.spare_parts.deduct')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:spare_parts.edit']);
            ...
            Route::get('/admin/service-jobs/create', [\App\Http\Controllers\Admin\ServiceJobController::class, 'create'])->name('store.admin.service_jobs.create')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:repairs.edit']);
            Route::post('/admin/service-jobs', [\App\Http\Controllers\Admin\ServiceJobController::class, 'store'])->name('store.admin.service_jobs.store')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:repairs.edit']);
            ...
            Route::get('/admin/service-jobs/{job}/edit', [\App\Http\Controllers\Admin\ServiceJobController::class, 'edit'])->name('store.admin.service_jobs.edit')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:repairs.edit']);
            Route::put('/admin/service-jobs/{job}', [\App\Http\Controllers\Admin\ServiceJobController::class, 'update'])->name('store.admin.service_jobs.update')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:repairs.edit']);
            Route::post('/admin/service-jobs/{job}/status', [\App\Http\Controllers\Admin\ServiceJobController::class, 'updateStatus'])->name('store.admin.service_jobs.status')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:repairs.edit']);
            Route::post('/admin/service-jobs/quick-add-technician', [\App\Http\Controllers\Admin\ServiceJobController::class, 'quickAddTechnician'])->name('store.admin.service_jobs.quick_add_technician')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:repairs.edit']);
            Route::post('/admin/service-jobs/{job}/payments', [\App\Http\Controllers\Admin\ServiceJobController::class, 'addPayment'])->name('store.admin.service_jobs.payments.store')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:repairs.edit']);
            Route::post('/admin/service-jobs/{job}/items/{item}/deduct', [\App\Http\Controllers\Admin\ServiceJobController::class, 'deductItem'])->name('store.admin.service_jobs.items.deduct')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:repairs.edit']);
        });
        ...
        Route::post('/admin/expense-categories', [ExpenseCategoryController::class, 'store'])->name('store.admin.expense_categories.store')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'finance_access', 'store.permission:expense_categories.edit']);
        Route::put('/admin/expense-categories/{category}', [ExpenseCategoryController::class, 'update'])->name('store.admin.expense_categories.update')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'finance_access', 'store.permission:expense_categories.edit']);
        Route::patch('/admin/expense-categories/{category}/toggle', [ExpenseCategoryController::class, 'toggle'])->name('store.admin.expense_categories.toggle')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'finance_access', 'store.permission:expense_categories.edit']);
        ...
        Route::post('/admin/expenses', [ExpenseController::class, 'store'])->name('store.admin.expenses.store')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'finance_access', 'store.permission:expenses.edit']);
        Route::put('/admin/expenses/{expense}', [ExpenseController::class, 'update'])->name('store.admin.expenses.update')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'finance_access', 'store.permission:expenses.edit']);
        ...
        Route::middleware('store.channel:online_store')->group(function () {
            ...
            Route::patch('/admin/reviews/{review}/approve', [AdminReviewController::class, 'toggleApprove'])->name('store.admin.reviews.approve')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:reviews.edit']);
        ...
        Route::middleware('store.channel:online_store')->group(function () {
            ...
            Route::post('/admin/banners', [HomeBannerController::class, 'store'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:banners.edit']);
            Route::get('/admin/banners/{banner}/edit', [HomeBannerController::class, 'edit'])->name('store.admin.banners.edit')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:banners.edit']);
            Route::put('/admin/banners/{banner}', [HomeBannerController::class, 'update'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:banners.edit']);
        ...
        Route::post('/admin/categories', [CategoryController::class, 'store'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        Route::post('/admin/categories/quick-store', [CategoryController::class, 'quickStore'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        Route::get('/admin/categories/{category}/edit', [CategoryController::class, 'edit'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        Route::put('/admin/categories/{category}', [CategoryController::class, 'update'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        ...
        Route::get('/admin/categories/import', [CategoryController::class, 'importForm'])->name('store.admin.categories.import')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        Route::post('/admin/categories/import', [CategoryController::class, 'import'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        Route::post('/admin/categories/import/confirm', [CategoryController::class, 'confirmImport'])->name('store.admin.categories.import.confirm')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        ...
        Route::post('/admin/brands', [BrandController::class, 'store'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        Route::post('/admin/brands/quick-store', [BrandController::class, 'quickStore'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        Route::get('/admin/brands/{brand}/edit', [BrandController::class, 'edit'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        Route::put('/admin/brands/{brand}', [BrandController::class, 'update'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        ...
        Route::get('/admin/brands/import', [BrandController::class, 'importForm'])->name('store.admin.brands.import')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        Route::post('/admin/brands/import', [BrandController::class, 'import'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        Route::post('/admin/brands/import/confirm', [BrandController::class, 'confirmImport'])->name('store.admin.brands.import.confirm')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        ...
        Route::get('/admin/variant-presets/import', [VariantPresetController::class, 'importForm'])->name('store.admin.variant-presets.import')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        Route::post('/admin/variant-presets/import', [VariantPresetController::class, 'import'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        Route::post('/admin/variant-presets/import/confirm', [VariantPresetController::class, 'confirmImport'])->name('store.admin.variant-presets.import.confirm')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        ...
        Route::post('/admin/variant-presets', [VariantPresetController::class, 'store'])->name('store.admin.variant-presets.store')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        Route::get('/admin/variant-presets/{variantPreset}/edit', [VariantPresetController::class, 'edit'])->name('store.admin.variant-presets.edit')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        Route::put('/admin/variant-presets/{variantPreset}', [VariantPresetController::class, 'update'])->name('store.admin.variant-presets.update')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        Route::post('/admin/variant-presets/{variantPreset}/duplicate', [VariantPresetController::class, 'duplicate'])->name('store.admin.variant-presets.duplicate')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        Route::patch('/admin/variant-presets/{variantPreset}/move', [VariantPresetController::class, 'move'])->name('store.admin.variant-presets.move')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        ...
        Route::get('/admin/product-master-presets/import', [\App\Http\Controllers\Admin\ProductMasterPresetController::class, 'importForm'])->name('store.admin.product-master-presets.import')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        Route::post('/admin/product-master-presets/import', [\App\Http\Controllers\Admin\ProductMasterPresetController::class, 'import'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        Route::post('/admin/product-master-presets/import/confirm', [\App\Http\Controllers\Admin\ProductMasterPresetController::class, 'confirmImport'])->name('store.admin.product-master-presets.import.confirm')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        ...
        Route::post('/admin/product-master-presets', [\App\Http\Controllers\Admin\ProductMasterPresetController::class, 'store'])->name('store.admin.product-master-presets.store')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        Route::put('/admin/product-master-presets/{masterPreset}', [\App\Http\Controllers\Admin\ProductMasterPresetController::class, 'update'])->name('store.admin.product-master-presets.update')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:master_data.edit']);
        ...
        Route::post('/admin/products/master-data/seed', [ProductMasterDataController::class, 'seedImport'])
            ...
            ->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:master_data.edit']);
        ...
        Route::post('/admin/suppliers', [SupplierController::class, 'store'])
            ...
            ->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:suppliers.edit']);
        ...
        Route::post('/admin/warehouses', [WarehouseController::class, 'store'])
            ...
            ->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:warehouses.edit']);
        ...
        Route::post('/admin/suppliers/quick-store', [SupplierController::class, 'quickStore'])
            ...
            ->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:suppliers.edit', 'throttle:60,1']);
        Route::get('/admin/products/create', [ProductController::class, 'create'])->name('store.admin.products.create')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:products.edit']);
        Route::post('/admin/products', [ProductController::class, 'store'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:products.edit']);
        Route::post('/admin/products/bulk-stock', [ProductController::class, 'bulkStock'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:products.edit']);
        Route::post('/admin/products/bulk-prices', [ProductController::class, 'bulkAdjustPrices'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:products.edit']);
        ...
        Route::get('/admin/products/{product}/edit', [ProductController::class, 'edit'])->name('store.admin.products.edit')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:products.edit']);
        Route::put('/admin/products/{product}', [ProductController::class, 'update'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:products.edit']);
        ...
        Route::post('/admin/products/{product}/toggle-featured', [ProductController::class, 'toggleFeatured'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:products.edit']);
        // Per-row + bulk "Sell Online" toggles (is_ecommerce).
        Route::post('/admin/products/{product}/toggle-ecommerce', [ProductController::class, 'toggleEcommerce'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:products.edit']);
        Route::post('/admin/products/bulk-ecommerce', [ProductController::class, 'bulkSetEcommerce'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:products.edit']);
        Route::post('/admin/products/{product}/duplicate', [ProductController::class, 'duplicate'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:products.edit']);

        // Admin Product Multiple Image Gallery
        Route::post('/admin/products/{product}/images', [ProductController::class, 'uploadImages'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:products.edit']);
        Route::post('/admin/products/{product}/images/{image}/primary', [ProductController::class, 'setPrimaryImage'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:products.edit']);
        Route::delete('/admin/products/{product}/images/{image}', [ProductController::class, 'deleteImage'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:products.edit']);
        ...
        Route::get('/admin/products/export', [ProductController::class, 'export'])->name('store.admin.products.export')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:products.view']);
        ...
        Route::post('/admin/products/import', [ProductController::class, 'import'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:product_import.edit', 'throttle:imports']);
        Route::post('/admin/products/import/confirm', [ProductController::class, 'confirmImport'])->name('store.admin.products.import.confirm')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:product_import.edit', 'throttle:imports']);
        ...
        Route::post('/admin/pilot-import/seed-store', [PilotImportController::class, 'seedStore'])->name('store.admin.pilot-import.seed-store')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:product_import.edit', 'throttle:imports']);
        Route::post('/admin/pilot-import/clean-store-data', [PilotImportController::class, 'cleanStoreData'])->name('store.admin.pilot-import.clean-store-data')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:product_import.edit', 'throttle:imports']);
        Route::post('/admin/pilot-import/demo-scenarios/{scenario}', [PilotImportController::class, 'createDemoScenario'])->name('store.admin.pilot-import.demo-scenarios.store')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:product_import.edit', 'throttle:imports']);
        Route::post('/admin/pilot-import/{tab}', [PilotImportController::class, 'import'])->name('store.admin.pilot-import.import')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:product_import.edit', 'throttle:imports'])->whereIn('tab', ['products', 'customers', 'suppliers', 'debt']);
        Route::post('/admin/pilot-import/{tab}/confirm', [PilotImportController::class, 'confirmImport'])->name('store.admin.pilot-import.confirm')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:product_import.edit', 'throttle:imports'])->whereIn('tab', ['products', 'customers', 'suppliers', 'debt']);
        ...
        Route::middleware(['store.capability:catalog.barcode_printing'])->group(function () {
            ...
            Route::post('/admin/barcode/templates', [\App\Http\Controllers\Admin\BarcodeLabelController::class, 'saveTemplate'])->name('store.admin.barcode.templates.save')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:barcode.edit']);
        ...
        Route::middleware(['store.capability:service.warranty_tracking'])->group(function () {
            ...
            Route::get('/admin/warranty/create', [\App\Http\Controllers\Admin\WarrantyTrackerController::class, 'create'])->name('store.admin.warranty.create')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:warranty.edit']);
            Route::post('/admin/warranty', [\App\Http\Controllers\Admin\WarrantyTrackerController::class, 'store'])->name('store.admin.warranty.store')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:warranty.edit']);
            ...
            Route::get('/admin/warranty/{warranty}/edit', [\App\Http\Controllers\Admin\WarrantyTrackerController::class, 'edit'])->name('store.admin.warranty.edit')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:warranty.edit']);
            Route::put('/admin/warranty/{warranty}', [\App\Http\Controllers\Admin\WarrantyTrackerController::class, 'update'])->name('store.admin.warranty.update')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:warranty.edit']);
            Route::post('/admin/warranty/{warranty}/claim', [\App\Http\Controllers\Admin\WarrantyTrackerController::class, 'claim'])->name('store.admin.warranty.claim')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:warranty.edit']);
        ...
        Route::get('/admin/stock-count/create', [\App\Http\Controllers\Admin\StockCountController::class, 'create'])->name('store.admin.stock_count.create')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:stock_count.edit']);
        Route::post('/admin/stock-count', [\App\Http\Controllers\Admin\StockCountController::class, 'store'])->name('store.admin.stock_count.store')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:stock_count.edit']);
        ...
        Route::post('/admin/stock-count/{stock_count}/line/{line}', [\App\Http\Controllers\Admin\StockCountController::class, 'updateLine'])->name('store.admin.stock_count.update_line')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:stock_count.edit']);
        Route::post('/admin/stock-count/{stock_count}/bulk-update', [\App\Http\Controllers\Admin\StockCountController::class, 'bulkUpdate'])->name('store.admin.stock_count.bulk_update')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:stock_count.edit']);
        ...
        Route::post('/admin/stock-count/{stock_count}/approve', [\App\Http\Controllers\Admin\StockCountController::class, 'approve'])->name('store.admin.stock_count.approve')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:stock_count.edit']);
        Route::post('/admin/stock-count/{stock_count}/cancel', [\App\Http\Controllers\Admin\StockCountController::class, 'cancel'])->name('store.admin.stock_count.cancel')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:stock_count.edit']);
        ...
        Route::get('/admin/stock-ledger/export', [\App\Http\Controllers\Admin\StockLedgerController::class, 'export'])->name('store.admin.stock_ledger.export')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:stock_ledger.view']);
        ...
        Route::middleware(['store.capability:catalog.price_wizard'])->group(function () {
            ...
            Route::post('/admin/price-wizard/apply', [\App\Http\Controllers\Admin\BulkPriceWizardController::class, 'apply'])->name('store.admin.price_wizard.apply')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:price_wizard.edit']);
        ...
        Route::post('/admin/transactions/deposit', [\App\Http\Controllers\Admin\CashBankTransactionController::class, 'deposit'])->name('store.admin.transactions.deposit')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'finance_access', 'store.permission:transactions.edit']);
        Route::post('/admin/transactions/withdraw', [\App\Http\Controllers\Admin\CashBankTransactionController::class, 'withdraw'])->name('store.admin.transactions.withdraw')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'finance_access', 'store.permission:transactions.edit']);
        Route::post('/admin/transactions/transfer', [\App\Http\Controllers\Admin\CashBankTransactionController::class, 'transfer'])->name('store.admin.transactions.transfer')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'finance_access', 'store.permission:transactions.edit']);
        Route::post('/admin/transactions/account', [\App\Http\Controllers\Admin\CashBankTransactionController::class, 'storeAccount'])->name('store.admin.transactions.account.store')->middleware([EnsureStoreAccess::class . ':store_manager', 'finance_access', 'store.permission:transactions.edit']);
        ...
        Route::get('/admin/printers/create', [\App\Http\Controllers\Admin\PrinterController::class, 'create'])->name('store.admin.printers.create')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
        Route::post('/admin/printers', [\App\Http\Controllers\Admin\PrinterController::class, 'store'])->name('store.admin.printers.store')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
        Route::get('/admin/printers/{printer}/edit', [\App\Http\Controllers\Admin\PrinterController::class, 'edit'])->name('store.admin.printers.edit')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
        Route::put('/admin/printers/{printer}', [\App\Http\Controllers\Admin\PrinterController::class, 'update'])->name('store.admin.printers.update')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
        ...
        Route::post('/admin/printers/{printer}/set-default', [\App\Http\Controllers\Admin\PrinterController::class, 'setDefault'])->name('store.admin.printers.set_default')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
        ...
        Route::post('/admin/vouchers', [\App\Http\Controllers\Admin\VoucherCustomizerController::class, 'store'])->name('store.admin.vouchers.store')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
        Route::put('/admin/vouchers/{voucher}', [\App\Http\Controllers\Admin\VoucherCustomizerController::class, 'update'])->name('store.admin.vouchers.update')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
        ...
        Route::post('/admin/vouchers/{voucher}/set-default', [\App\Http\Controllers\Admin\VoucherCustomizerController::class, 'setDefault'])->name('store.admin.vouchers.set_default')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
        ...
        Route::middleware(['store.capability:operations.branches'])->group(function () {
            ...
            Route::get('/admin/branches/create', [\App\Http\Controllers\Admin\BranchManagementController::class, 'create'])->name('store.admin.branches.create')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
            Route::post('/admin/branches', [\App\Http\Controllers\Admin\BranchManagementController::class, 'store'])->name('store.admin.branches.store')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
            ...
            Route::get('/admin/branches/{branch}/edit', [\App\Http\Controllers\Admin\BranchManagementController::class, 'edit'])->name('store.admin.branches.edit')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
            Route::put('/admin/branches/{branch}', [\App\Http\Controllers\Admin\BranchManagementController::class, 'update'])->name('store.admin.branches.update')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
            ...
            Route::post('/admin/branches/{branch}/set-default', [\App\Http\Controllers\Admin\BranchManagementController::class, 'setDefault'])->name('store.admin.branches.set_default')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
        });
        ...
        Route::post('/admin/exchange-rates', [\App\Http\Controllers\Admin\CurrencyExchangeController::class, 'store'])->name('store.admin.exchange_rates.store')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
        Route::post('/admin/exchange-rates/bulk-update', [\App\Http\Controllers\Admin\CurrencyExchangeController::class, 'bulkUpdate'])->name('store.admin.exchange_rates.bulk_update')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
        ...
        Route::put('/admin/exchange-rates/{currency}', [\App\Http\Controllers\Admin\CurrencyExchangeController::class, 'update'])->name('store.admin.exchange_rates.update')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:settings.edit']);
        ...
        Route::middleware(['store.capability:commerce.loyalty_points'])->group(function () {
            ...
            Route::post('/admin/membership/tiers', [\App\Http\Controllers\Admin\MembershipLoyaltyController::class, 'storeTier'])->name('store.admin.membership.tiers.store')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:membership.edit']);
            Route::put('/admin/membership/tiers/{tier}', [\App\Http\Controllers\Admin\MembershipLoyaltyController::class, 'updateTier'])->name('store.admin.membership.tiers.update')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:membership.edit']);
            ...
            Route::post('/admin/membership/adjust-points', [\App\Http\Controllers\Admin\MembershipLoyaltyController::class, 'adjustPoints'])->name('store.admin.membership.adjust_points')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:membership.edit']);
            Route::post('/admin/membership/assign-tier', [\App\Http\Controllers\Admin\MembershipLoyaltyController::class, 'assignTier'])->name('store.admin.membership.assign_tier')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:membership.edit']);
        });
        ...
        Route::post('/admin/promotions', [\App\Http\Controllers\Admin\PromotionController::class, 'store'])->name('store.admin.promotions.store')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:promotions.edit']);
        ...
        Route::put('/admin/promotions/{promotion}', [\App\Http\Controllers\Admin\PromotionController::class, 'update'])->name('store.admin.promotions.update')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:promotions.edit']);
        Route::post('/admin/promotions/{promotion}/toggle', [\App\Http\Controllers\Admin\PromotionController::class, 'toggle'])->name('store.admin.promotions.toggle')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:promotions.edit']);
        ...
        Route::middleware(['store.channel:online_store'])->group(function () {
            ...
            Route::post('/admin/web-products/toggle-visibility', [\App\Http\Controllers\Admin\WebProductController::class, 'toggleVisibility'])->name('store.admin.web_products.toggle_visibility')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:web_products.edit']);
            Route::post('/admin/web-products/toggle-featured', [\App\Http\Controllers\Admin\WebProductController::class, 'toggleFeatured'])->name('store.admin.web_products.toggle_featured')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:web_products.edit']);
            Route::post('/admin/web-products/bulk-visibility', [\App\Http\Controllers\Admin\WebProductController::class, 'bulkVisibility'])->name('store.admin.web_products.bulk_visibility')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:web_products.edit']);
            Route::post('/admin/web-products/bulk-featured', [\App\Http\Controllers\Admin\WebProductController::class, 'bulkFeatured'])->name('store.admin.web_products.bulk_featured')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:web_products.edit']);
        });
        ...
        Route::middleware(['store.capability:operations.eload'])->group(function () {
            ...
            Route::post('/admin/eload', [\App\Http\Controllers\Admin\EloadController::class, 'store'])->name('store.admin.eload.store')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:pos_eload.edit']);
            Route::post('/admin/eload/refill', [\App\Http\Controllers\Admin\EloadController::class, 'refill'])->name('store.admin.eload.refill')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:pos_eload.edit']);
            Route::post('/admin/eload/accounts', [\App\Http\Controllers\Admin\EloadController::class, 'saveAccount'])->name('store.admin.eload.accounts.store')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:pos_eload.edit']);
            ...
            Route::patch('/admin/eload/transactions/{id}/status', [\App\Http\Controllers\Admin\EloadController::class, 'updateStatus'])->name('store.admin.eload.status')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:pos_eload.edit']);
        ...
        Route::get('/admin/reports/sales-analytics/export', [\App\Http\Controllers\Admin\SalesAnalyticsController::class, 'exportCsv'])->name('store.admin.sales_analytics.export')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:sales_analytics.view']);
        ...
        Route::get('/admin/reports/inventory-valuation/export', [\App\Http\Controllers\Admin\InventoryValuationController::class, 'exportCsv'])->name('store.admin.inventory_valuation.export')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:inventory_valuation.view']);
        ...
        Route::get('/admin/reports/debt-aging/export', [\App\Http\Controllers\Admin\DebtAgingController::class, 'exportCsv'])->name('store.admin.debt_aging.export')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:debt_aging.view']);
        ...
        Route::post('/admin/security/roles', [\App\Http\Controllers\Admin\StaffRoleController::class, 'store'])->name('store.admin.roles.store')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:roles.edit']);
        Route::put('/admin/security/roles/{role}', [\App\Http\Controllers\Admin\StaffRoleController::class, 'update'])->name('store.admin.roles.update')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:roles.edit']);
        ...
        Route::post('/admin/security/roles/assign-staff', [\App\Http\Controllers\Admin\StaffRoleController::class, 'assignStaff'])->name('store.admin.roles.assign_staff')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:roles.edit']);
        Route::get('/admin/security/roles/export', [\App\Http\Controllers\Admin\StaffRoleController::class, 'exportCsv'])->name('store.admin.roles.export')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:roles.view']);

        // System Audit Trail Logs (sidebar_audit_logs)
        Route::get('/admin/security/audit-logs/export', [\App\Http\Controllers\Admin\AuditLogController::class, 'export'])->name('store.admin.audit-logs.export')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:audit_logs.view']);
        ...
        Route::post('/admin/backups', [BackupController::class, 'store'])->name('store.admin.backups.store')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:backups.edit']);
        ...
        Route::post('/admin/sync/retry/{id}', [\App\Http\Controllers\Admin\SyncAdminController::class, 'retry'])->name('store.admin.sync.retry')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:settings.edit']);
        Route::post('/admin/sync/retry-all', [\App\Http\Controllers\Admin\SyncAdminController::class, 'retryAll'])->name('store.admin.sync.retry_all')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:settings.edit']);
        ...
        Route::post('/admin/backups/restore', [BackupController::class, 'restore'])->name('store.admin.backups.restore')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:backups.edit']);
        Route::post('/admin/backups/upload-restore', [BackupController::class, 'uploadRestore'])->name('store.admin.backups.upload_restore')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:backups.edit']);
        ...
        Route::post('/admin/database/vacuum', [\App\Http\Controllers\Admin\DatabaseToolController::class, 'vacuum'])->name('store.admin.database.vacuum')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:database.edit']);
        Route::post('/admin/database/optimize', [\App\Http\Controllers\Admin\DatabaseToolController::class, 'optimize'])->name('store.admin.database.optimize')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:database.edit']);
        Route::post('/admin/database/integrity-check', [\App\Http\Controllers\Admin\DatabaseToolController::class, 'integrityCheck'])->name('store.admin.database.integrity')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:database.edit']);
        Route::post('/admin/database/clear-cache', [\App\Http\Controllers\Admin\DatabaseToolController::class, 'clearCache'])->name('store.admin.database.clear_cache')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:database.edit']);
        ...
        Route::post('/admin/alerts/test-ping', [\App\Http\Controllers\Admin\SystemAlertCenterController::class, 'testNotification'])->name('store.admin.alerts.test_ping')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:alerts.edit']);
        Route::post('/admin/alerts/daily-summary', [\App\Http\Controllers\Admin\SystemAlertCenterController::class, 'sendDailySummary'])->name('store.admin.alerts.daily_summary')->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:alerts.edit']);
        ...
        Route::middleware(['store.capability:commerce.wholesale_pricing'])->group(function () {
            ...
            Route::patch('/admin/wholesale/applications/{application}', [WholesaleAdminController::class, 'updateStatus'])->name('store.admin.wholesale.applications.update')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:wholesale.edit']);
        ...
        Route::middleware(['store.capability:storefront.glass_finder'])->group(function () {
            ...
            Route::post('/admin/glass-finder', [GlassFinderAdminController::class, 'store'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:glass_finder.edit']);
            Route::get('/admin/glass-finder/{item}/edit', [GlassFinderAdminController::class, 'edit'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:glass_finder.edit']);
            Route::put('/admin/glass-finder/{item}', [GlassFinderAdminController::class, 'update'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:glass_finder.edit']);
            ...
            Route::post('/admin/glass-finder/import', [GlassFinderAdminController::class, 'import'])->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:glass_finder.edit', 'throttle:imports']);
            Route::post('/admin/glass-finder/import/confirm', [GlassFinderAdminController::class, 'confirmImport'])->name('store.admin.glass-finder.import.confirm')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:glass_finder.edit', 'throttle:imports']);
        ...
        Route::middleware(['store.channel:online_ordering'])->group(function () {
            ...
            Route::patch('/admin/orders/{order}/status', [OrderAdminController::class, 'updateStatus'])->name('store.admin.orders.update_status')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:ecommerce_orders.edit']);
            Route::patch('/admin/orders/{order}/finances', [OrderAdminController::class, 'updateFinances'])->name('store.admin.orders.update_finances')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:ecommerce_orders.edit']);
            Route::patch('/admin/orders/{order}/note', [OrderAdminController::class, 'updateNote'])->name('store.admin.orders.update_note')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.permission:ecommerce_orders.edit']);
        ...
        Route::prefix('/pos')->middleware([EnsureStoreAccess::class . ':store_manager,staff', 'store.channel:pos'])->group(function () {
            ...
            Route::post('/shifts', [\App\POS\Http\Controllers\CashierShiftController::class, 'open'])->name('pos.shifts.open')->middleware(['store.capability:operations.cashier_shifts', 'store.permission:pos_closing.edit']);
            Route::post('/shifts/{shift}/cash-events', [\App\POS\Http\Controllers\CashierShiftController::class, 'cashEvent'])->name('pos.shifts.cash-event')->middleware(['store.capability:operations.cashier_shifts', 'store.permission:pos_closing.edit']);
            Route::post('/shifts/{shift}/close', [\App\POS\Http\Controllers\CashierShiftController::class, 'close'])->name('pos.shifts.close')->middleware(['store.capability:operations.cashier_shifts', 'store.permission:pos_closing.edit']);
            ...
            Route::post('/customers', [\App\POS\Http\Controllers\PosSaleController::class, 'addCustomer'])->name('pos.customers.add')->middleware('store.permission:pos_sales.edit');
            Route::post('/customers/{customer}/attach', [\App\POS\Http\Controllers\PosSaleController::class, 'attachCustomer'])->name('pos.customers.attach')->middleware('store.permission:pos_sales.edit');
            Route::post('/customers/detach', [\App\POS\Http\Controllers\PosSaleController::class, 'detachCustomer'])->name('pos.customers.detach')->middleware('store.permission:pos_sales.edit');
            Route::post('/customers/{customer}/collect', [\App\POS\Http\Controllers\PosSaleController::class, 'collect'])->name('pos.customers.collect')->middleware('store.permission:pos_sales.edit');
            Route::post('/cart', [\App\POS\Http\Controllers\PosSaleController::class, 'addItem'])->name('pos.cart.add')->middleware('store.permission:pos_sales.edit');
            // /cart/clear must be registered before /cart/{line} (route order).
            Route::post('/cart/clear', [\App\POS\Http\Controllers\PosSaleController::class, 'clearCart'])->name('pos.cart.clear')->middleware('store.permission:pos_sales.edit');
            Route::post('/cart/{line}', [\App\POS\Http\Controllers\PosSaleController::class, 'updateLine'])->name('pos.cart.update')->middleware('store.permission:pos_sales.edit');
            Route::post('/cart/{line}/price', [\App\POS\Http\Controllers\PosSaleController::class, 'setLinePrice'])->name('pos.cart.price')->middleware('store.permission:pos_sales.edit');
            Route::delete('/cart/{line}', [\App\POS\Http\Controllers\PosSaleController::class, 'removeLine'])->name('pos.cart.remove')->middleware('store.permission:pos_sales.edit');
            Route::post('/hold', [\App\POS\Http\Controllers\PosSaleController::class, 'hold'])->name('pos.hold')->middleware('store.permission:pos_sales.edit');
            Route::post('/resume/{sale}', [\App\POS\Http\Controllers\PosSaleController::class, 'resume'])->name('pos.resume')->middleware('store.permission:pos_sales.edit');
            Route::post('/void/{sale}', [\App\POS\Http\Controllers\PosSaleController::class, 'void'])->name('pos.void')->middleware('store.permission:pos_sales.edit');
            Route::post('/post/{sale?}', [\App\POS\Http\Controllers\PosSaleController::class, 'post'])->name('pos.post')->middleware('store.permission:pos_sales.edit');
            ...
            Route::post('/sales/{sale}/refunds', [\App\POS\Http\Controllers\PosReturnController::class, 'store'])->name('pos.refund.store')->middleware('store.permission:pos_returns.edit');
            ...
            Route::post('/closing', [\App\POS\Http\Controllers\DailyClosingController::class, 'store'])->name('pos.closing.store')->middleware(['store.capability:operations.cashier_shifts', 'store.permission:pos_closing.edit']);
            Route::post('/closing/{closing}/approve', [\App\POS\Http\Controllers\DailyClosingController::class, 'approve'])->name('pos.closing.approve')
                ->middleware([EnsureStoreAccess::class . ':store_manager', 'store.capability:operations.cashier_shifts', 'store.permission:pos_closing.edit']);
            ...
            Route::get('/reports/sales/export', [\App\POS\Http\Controllers\PosReportController::class, 'exportSales'])->name('pos.reports.sales.export')->middleware('store.permission:reports_sales.view');
            ...
            Route::get('/reports/cash/export', [\App\POS\Http\Controllers\PosReportController::class, 'exportCash'])->name('pos.reports.cash.export')->middleware('store.permission:reports_cash.view');
            ...
            Route::get('/reports/stock/export', [\App\POS\Http\Controllers\PosReportController::class, 'exportStock'])->name('pos.reports.stock.export')->middleware('store.permission:inventory_valuation.view');
            ...
            Route::get('/reports/services/export', [\App\POS\Http\Controllers\PosReportController::class, 'exportServices'])->name('pos.reports.services.export')->middleware('store.permission:reports_services.view');
            ...
            Route::post('/purchases/payables/{supplier}/pay', [\App\POS\Http\Controllers\PurchaseOrderController::class, 'payablesPay'])->name('pos.purchases.payables.pay')->middleware('store.permission:payables.edit');
            ...
            Route::get('/purchases/create', [\App\POS\Http\Controllers\PurchaseOrderController::class, 'create'])->name('pos.purchases.create')->middleware('store.permission:purchases.edit');
            Route::post('/purchases', [\App\POS\Http\Controllers\PurchaseOrderController::class, 'store'])->name('pos.purchases.store')->middleware('store.permission:purchases.edit');
            ...
            Route::get('/purchases/{purchaseOrder}/edit', [\App\POS\Http\Controllers\PurchaseOrderController::class, 'edit'])
                ...
                ->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:purchases.edit']);
            ...
            Route::post('/purchases/{purchaseOrder}/order', [\App\POS\Http\Controllers\PurchaseOrderController::class, 'order'])->name('pos.purchases.order')->middleware('store.permission:purchases.edit');
            Route::post('/purchases/{purchaseOrder}/receive', [\App\POS\Http\Controllers\PurchaseOrderController::class, 'receive'])->name('pos.purchases.receive')->middleware('store.permission:purchases.edit');
            Route::post('/purchases/{purchaseOrder}/cancel', [\App\POS\Http\Controllers\PurchaseOrderController::class, 'cancel'])->name('pos.purchases.cancel')->middleware('store.permission:purchases.edit');
            Route::post('/purchases/{purchaseOrder}/return', [\App\POS\Http\Controllers\PurchaseOrderController::class, 'returnItems'])->name('pos.purchases.return')->middleware('store.permission:purchase_returns.edit');
            Route::post('/purchases/{purchaseOrder}/pay', [\App\POS\Http\Controllers\PurchaseOrderController::class, 'pay'])->name('pos.purchases.pay')->middleware('store.permission:purchases.edit');
            Route::post('/purchases/{purchaseOrder}/vouchers', [\App\POS\Http\Controllers\PurchaseOrderController::class, 'uploadVouchers'])->name('pos.purchases.upload-vouchers')->middleware('store.permission:purchases.edit');
            Route::delete('/purchases/{purchaseOrder}/vouchers/{index}', [\App\POS\Http\Controllers\PurchaseOrderController::class, 'deleteVoucher'])->name('pos.purchases.delete-voucher')->middleware('store.permission:purchases.edit');
            ...
            Route::get('/transfers/create', [\App\Http\Controllers\POS\TransferController::class, 'create'])->name('pos.transfers.create')->middleware('store.permission:transfers.edit');
            Route::post('/transfers', [\App\Http\Controllers\POS\TransferController::class, 'store'])->name('pos.transfers.store')->middleware('store.permission:transfers.edit');
            ...
            Route::post('/transfers/{transfer}/ship', [\App\Http\Controllers\POS\TransferController::class, 'ship'])->name('pos.transfers.ship')->middleware('store.permission:transfers.edit');
            Route::post('/transfers/{transfer}/receive', [\App\Http\Controllers\POS\TransferController::class, 'receive'])->name('pos.transfers.receive')->middleware('store.permission:transfers.edit');
            Route::post('/transfers/{transfer}/cancel', [\App\Http\Controllers\POS\TransferController::class, 'cancel'])->name('pos.transfers.cancel')->middleware('store.permission:transfers.edit');
            ...
            Route::get('/buy-back/create', [\App\Http\Controllers\POS\BuyBackController::class, 'create'])->name('pos.buybacks.create')->middleware('store.permission:pos_buyback.edit');
            Route::post('/buy-back', [\App\Http\Controllers\POS\BuyBackController::class, 'store'])->name('pos.buybacks.store')->middleware('store.permission:pos_buyback.edit');
            ...
            Route::post('/buy-back/{buyback}/complete', [\App\Http\Controllers\POS\BuyBackController::class, 'complete'])->name('pos.buybacks.complete')->middleware('store.permission:pos_buyback.edit');
            Route::post('/buy-back/{buyback}/cancel', [\App\Http\Controllers\POS\BuyBackController::class, 'cancel'])->name('pos.buybacks.cancel')->middleware('store.permission:pos_buyback.edit');
            ...
            Route::get('/returns/new', [\App\Http\Controllers\POS\ReturnsController::class, 'create'])->name('pos.returns.create')->middleware('store.permission:pos_returns.edit');
            ...
            Route::post('/opening-stock', [\App\POS\Http\Controllers\OpeningStockController::class, 'store'])->name('pos.opening-stock.store')->middleware('store.permission:opening_stock.edit');
            Route::post('/opening-stock/{openingStockRequest}/approve', [\App\POS\Http\Controllers\OpeningStockController::class, 'approve'])->name('pos.opening-stock.approve')
                ->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:opening_stock.edit']);
            ...
            Route::post('/reconciliation/approve', [\App\POS\Http\Controllers\InventoryReconciliationController::class, 'approve'])->name('pos.reconciliation.approve')
                ->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:stock_reconciliation.edit']);
            ...
            Route::post('/adjustments', [\App\POS\Http\Controllers\InventoryAdjustmentController::class, 'store'])->name('pos.adjustments.store')->middleware('store.permission:stock_adjustments.edit');
            Route::post('/adjustments/{inventoryAdjustment}/approve', [\App\POS\Http\Controllers\InventoryAdjustmentController::class, 'approve'])->name('pos.adjustments.approve')
                ->middleware([EnsureStoreAccess::class . ':store_manager', 'store.permission:stock_adjustments.edit']);
