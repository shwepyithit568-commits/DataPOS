    ...
    private function importCategories(Store $store, string $businessType = 'tech'): int
    {
        ...
        foreach ($this->categoryTree($businessType) as $parentItem) {
            ...
            $parent = Category::updateOrCreate(
                ...
                ['code' => $parentItem['code'], 'icon' => $parentItem['icon'] ?? null, 'slug' => $parentSlug, 'parent_id' => null]
            );
            $count++;
            foreach ($parentItem['subs'] ?? [] as $subItem) {
                ...
                Category::updateOrCreate(
                    ...
                    ['code' => $subItem['code'], 'icon' => $subItem['icon'] ?? null, 'slug' => $subSlug]
                );
                $count++;
            }
        }
    ...
    private function techCategoryTree(): array
    {
        return [
            [
                ...
                'subs' => [
                    ['name' => 'Cable (ကြိုး)',            'code' => 'CB',   'icon' => '🔌'],
                    ['name' => 'Charger (အားသွင်းခေါင်း)', 'code' => 'CH',   'icon' => '⚡'],
                    ['name' => 'Charger Set',               'code' => 'CHS',  'icon' => '🔌'],
                    ['name' => 'Car Charger (ကားအားသွင်း)', 'code' => 'CCH',  'icon' => '🚗'],
            ...
            [
                ...
                'subs' => [
                    ['name' => 'Earphone (နားကြပ်)',         'code' => 'EP',   'icon' => '🎧'],
                    ['name' => 'Bluetooth Earphone (TWS)',    'code' => 'BEP',  'icon' => '📶'],
                    ['name' => 'Bluetooth Speaker',           'code' => 'SPK',  'icon' => '🔊'],
                    ['name' => 'Microphone',                  'code' => 'MIC',  'icon' => '🎙️'],
                    ['name' => 'Wired Headset',               'code' => 'WHS',  'icon' => '🎧'],
                ],
            ],
            [
                'name' => 'Power & Storage',  'code' => 'PWR', 'icon' => '🔋',
                'subs' => [
                    ['name' => 'Power Bank (ပါဝါဘဏ်)',     'code' => 'PB',  'icon' => '🔋'],
                    ['name' => 'Memory Card (မမိုရီကတ်)',   'code' => 'SD',  'icon' => '💾'],
            ...
            [
                ...
                'subs' => [
                    ['name' => 'Touch LCD (ထိသောမျက်နှာပြင်)',    'code' => 'TL',     'icon' => '📱'],
                    ['name' => 'Original Touch LCD',               'code' => 'TL_ORG', 'icon' => '📱'],
                    ['name' => 'Touch Screen (ကော်မကပ်)',          'code' => 'TS',     'icon' => '📱'],
                    ['name' => 'Front Glass (မှန်ချပ်)',            'code' => 'GLS',    'icon' => '🛡️'],
                    ['name' => 'OCA Glass',                        'code' => 'OCA',    'icon' => '🛡️'],
                    ['name' => 'Screen Protector (မျက်နှာပြင်ကာ)', 'code' => 'SG',     'icon' => '🛡️'],
            ...
            [
                ...
                'subs' => [
                    ['name' => 'Silicone Case (ဆေး)',         'code' => 'SIL', 'icon' => '🛡️'],
                    ...
                    ['name' => 'Ring Holder / Stand',          'code' => 'RNG', 'icon' => '🧲'],
            ...
            [
                ...
                'subs' => [
                    ['name' => 'Original Battery (မူရင်း)',  'code' => 'BT_ORG', 'icon' => '🔋'],
                    ['name' => 'Standard Battery (သာမန်)',   'code' => 'BT_STD', 'icon' => '🔋'],
            ...
            [
                ...
                'subs' => [
                    ...
                    ['name' => 'Body Frame (ဘောင်)',        'code' => 'BD',  'icon' => '🗜️'],
            ...
            [
                ...
                'subs' => [
                    ['name' => 'Charging Port / Flex',  'code' => 'USBFIX', 'icon' => '🔧'],
                    ['name' => 'Power Button Flex',     'code' => 'PWRSW',  'icon' => '🔘'],
            ...
            [
                'name' => 'Computer Peripherals',  'code' => 'ELEC', 'icon' => '💻',
                'subs' => [
                    ['name' => 'Mouse (မောက်)',             'code' => 'MOU',  'icon' => '🖱️'],
                    ['name' => 'Keyboard (ကီးဘုတ်)',        'code' => 'KBD',  'icon' => '⌨️'],
                    ['name' => 'Webcam',                    'code' => 'WCM',  'icon' => '📷'],
                    ['name' => 'Cooling Pad / Fan',         'code' => 'FAN',  'icon' => '💨'],
                    ['name' => 'USB Cable / Adapter',       'code' => 'USBAD', 'icon' => '🔌'],
                    ['name' => 'Monitor / Display Cable',   'code' => 'HDMI', 'icon' => '🖥️'],
                    ['name' => 'LED Light Strip',           'code' => 'LED',  'icon' => '💡'],
                ],
            ],
            [
