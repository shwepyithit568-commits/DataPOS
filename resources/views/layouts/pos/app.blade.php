        ...
        <div class="mx-auto max-w-[1600px] px-4 py-3 flex items-center justify-between gap-3">
            ...
            <div class="flex items-center gap-2">
                ...
                <form method="POST" action="{{ url('/logout') }}">
                    @csrf
                    <button type="submit" class="text-xs font-semibold px-3 py-1.5 rounded-lg bg-slate-100 dark:bg-slate-800 hover:bg-rose-100 dark:hover:bg-rose-900/40 hover:text-rose-600 dark:hover:text-rose-400 transition">
                        🚪 {{ __('messages.logout') }}
                    </button>
                </form>
            </div>
