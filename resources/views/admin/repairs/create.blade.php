...
<div class="max-w-4xl mx-auto space-y-5 sm:space-y-6">
    ...
    <div class="admin-page-header">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h1 class="admin-page-title">{{ __('messages.repair_new_job') }}</h1>
                <p class="admin-page-sub">{{ $store->name }}</p>
            </div>
        </div>
    </div>
    ...
    <form method="POST" action="{{ route('store.admin.repairs.store', $storeRouteParams) }}"
        ...
        <fieldset class="space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="contact_phone" value="{{ old('contact_phone') }}" maxlength="40"
                           class="w-full border dark:border-slate-600 rounded-lg px-3 py-2.5 text-sm bg-white dark:bg-slate-900 text-gray-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-violet-500" />
                </div>
            </div>
        </fieldset>
        ...
        <fieldset class="space-y-4 pt-4 border-t dark:border-slate-700">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="device_type" value="{{ old('device_type') }}" required maxlength="60"
                           placeholder="{{ __('messages.repair_device_type_placeholder') }}"
                           class="w-full border dark:border-slate-600 rounded-lg px-3 py-2.5 text-sm bg-white dark:bg-slate-900 text-gray-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-violet-500" />
                </div>
                <div>
                    <label class="block text-xs font-semibold text-gray-600 dark:text-slate-300 mb-1">{{ __('messages.repair_model') }}</label>
                    <input type="text" name="model" value="{{ old('model') }}" maxlength="120"
                ...
                <div>
                    ...
                    <input type="text" name="imei_serial" value="{{ old('imei_serial') }}" maxlength="60"
            ...
            <div>
                ...
                <textarea name="reported_problem" rows="3" required maxlength="1000"
                          class="w-full border dark:border-slate-600 rounded-lg px-3 py-2.5 text-sm bg-white dark:bg-slate-900 text-gray-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-violet-500">{{ old('reported_problem') }}</textarea>
            </div>

            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label class="block text-xs font-semibold text-gray-600 dark:text-slate-300 mb-1">{{ __('messages.repair_intake_condition') }}</label>
                    <textarea name="intake_condition" rows="2" maxlength="1000" placeholder="{{ __('messages.repair_intake_placeholder') }}"
                              class="w-full border dark:border-slate-600 rounded-lg px-3 py-2.5 text-sm bg-white dark:bg-slate-900 text-gray-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-violet-500">{{ old('intake_condition') }}</textarea>
                </div>
                <div>
                    <label class="block text-xs font-semibold text-gray-600 dark:text-slate-300 mb-1">{{ __('messages.repair_accessories') }}</label>
                    <textarea name="accessories" rows="2" maxlength="500" placeholder="{{ __('messages.repair_accessories_placeholder') }}"
                              class="w-full border dark:border-slate-600 rounded-lg px-3 py-2.5 text-sm bg-white dark:bg-slate-900 text-gray-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-violet-500">{{ old('accessories') }}</textarea>
                </div>
            </div>
        </fieldset>
        ...
        <fieldset class="space-y-4 pt-4 border-t dark:border-slate-700" x-data="{
            ...
            useAsEstimate() {
                const el = document.getElementById('repair_estimated_charge');
        ...
        <fieldset class="space-y-4 pt-4 border-t dark:border-slate-700">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="number" id="repair_estimated_charge" name="estimated_charge" value="{{ old('estimated_charge') }}" min="0" step="0.01"
                           class="w-full border dark:border-slate-600 rounded-lg px-3 py-2.5 text-sm bg-white dark:bg-slate-900 text-gray-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-violet-500" />
                </div>
                <div>
                    <label class="block text-xs font-semibold text-gray-600 dark:text-slate-300 mb-1">{{ __('messages.repair_voucher_no') }}</label>
                    <input type="text" name="voucher_no" value="{{ old('voucher_no') }}" maxlength="40"
                           placeholder="{{ __('messages.repair_voucher_placeholder') }}"
                           class="w-full border dark:border-slate-600 rounded-lg px-3 py-2.5 text-sm bg-white dark:bg-slate-900 text-gray-900 dark:text-slate-100 font-mono focus:outline-none focus:ring-2 focus:ring-violet-500" />
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="warranty_notes" value="{{ old('warranty_notes') }}" maxlength="1000"
            ...
            <div>
                ...
                <textarea name="notes" rows="2" maxlength="1000"
                          class="w-full border dark:border-slate-600 rounded-lg px-3 py-2.5 text-sm bg-white dark:bg-slate-900 text-gray-900 dark:text-slate-100 focus:outline-none focus:ring-2 focus:ring-violet-500">{{ old('notes') }}</textarea>
            </div>
        </fieldset>
