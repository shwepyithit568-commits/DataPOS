    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-3">
        ...
        <div class="rounded-xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 p-3 shadow-sm">
            <div class="flex items-center justify-between text-xs font-semibold text-slate-500 dark:text-slate-400">
                <span class="text-violet-600 dark:text-violet-400">{{ __('messages.import_history_total_imports') }}</span>
                <span>📁</span>
            </div>
            ...
            <p class="text-[11px] text-slate-400 truncate">{{ __('messages.import_history_total_imports_sub') }}</p>
        </div>

        {{-- Successful Rows --}}
        <div class="rounded-xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 p-3 shadow-sm">
            <div class="flex items-center justify-between text-xs font-semibold text-slate-500 dark:text-slate-400">
                <span class="text-emerald-600 dark:text-emerald-400">{{ __('messages.import_history_successful_rows') }}</span>
                <span>✓</span>
            </div>
            ...
            <p class="text-[11px] text-slate-400 truncate">{{ __('messages.import_history_successful_rows_sub') }}</p>
        </div>

        {{-- Failed Rows --}}
        <div class="rounded-xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 p-3 shadow-sm">
            <div class="flex items-center justify-between text-xs font-semibold text-slate-500 dark:text-slate-400">
                <span class="text-rose-600 dark:text-rose-400">{{ __('messages.import_history_failed_rows') }}</span>
                <span>⚠️</span>
            </div>
            ...
            <p class="text-[11px] text-slate-400 truncate">{{ __('messages.import_history_failed_rows_sub') }}</p>
        </div>

        {{-- Success Rate --}}
        <div class="rounded-xl bg-white dark:bg-slate-900 border border-slate-200/90 dark:border-slate-800 p-3 shadow-sm">
            <div class="flex items-center justify-between text-xs font-semibold text-slate-500 dark:text-slate-400">
                <span class="text-sky-600 dark:text-sky-400">{{ __('messages.import_history_success_rate') }}</span>
                <span>📊</span>
            </div>
            ...
            <p class="text-[11px] text-slate-400 truncate">{{ __('messages.import_history_success_rate_sub') }}</p>
        </div>
    </div>
            ...
            <table class="min-w-[920px] w-full text-left text-xs">
                <thead>
                    <tr class="border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-800 text-slate-500 dark:text-slate-400 font-bold uppercase tracking-wider">
                        <th class="py-2.5 px-3.5">{{ __('messages.import_history_th_date') }}</th>
                        <th class="py-2.5 px-3.5">{{ __('messages.import_history_th_type') }}</th>
                        <th class="py-2.5 px-3.5">{{ __('messages.import_history_th_file') }}</th>
                        <th class="py-2.5 px-3.5 text-right">{{ __('messages.import_history_th_total') }}</th>
                        <th class="py-2.5 px-3.5 text-right">{{ __('messages.import_history_th_success') }}</th>
                        <th class="py-2.5 px-3.5 text-right">{{ __('messages.import_history_th_failed') }}</th>
                        <th class="py-2.5 px-3.5 text-center">{{ __('messages.import_history_th_status') }}</th>
                        <th class="py-2.5 px-3.5">{{ __('messages.import_history_th_actor') }}</th>
                        <th class="py-2.5 px-3.5 text-right">{{ __('messages.import_history_th_action') }}</th>
                    </tr>
                </thead>
