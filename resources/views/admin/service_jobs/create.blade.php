...
<div class="space-y-6 pb-12" x-data="repairTicketForm({
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-xs text-slate-500 dark:text-slate-400">{{ $store->name }} Â· {{ __('messages.sidebar_service_jobs') }}</p>
            </div>
        </div>
    ...
    {{-- Main Ticket Form --}}
    <form method="POST" action="{{ route('store.admin.service_jobs.store', $storeRouteParams) }}" id="repairForm" class="space-y-6">
        @csrf
                    ...
                    <div class="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3 mb-4">
                        <div class="flex items-center gap-2.5">
                            ...
                            <div>
                                ...
                                <p class="text-[11px] text-slate-400">á€›á€¾á€¬á€–á€½á€±á€›á€½á€±á€¸á€á€»á€šá€ºá€•á€« á€žá€­á€¯á€·á€™á€Ÿá€¯á€á€º á€á€­á€¯á€€á€ºá€›á€­á€¯á€€á€ºá€›á€­á€¯á€€á€ºá€‘á€Šá€·á€ºá€•á€«</p>
                            </div>
                        </div>
                    ...
                    <div class="space-y-3.5">
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-1">
                                ...
                                <template x-if="customerId">
                                    <span class="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[10px] font-bold bg-emerald-50 dark:bg-emerald-950/60 text-emerald-700 dark:text-emerald-300 border border-emerald-200 dark:border-emerald-800">
                                        <span>âœ“ {{ __('messages.registered_customer') }}</span>
                                        <button type="button" @click="clearCustomer()" class="text-rose-500 hover:text-rose-700 font-bold ml-1" title="Detach">[âœ•]</button>
                                    </span>
                                </template>
                            </div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="contact_name" x-model="contactName" @input="onContactNameInput()" @focus="showCustomerDropdown = true"
                                       placeholder="á€–á€±á€¬á€€á€ºá€žá€Šá€º á€¡á€™á€Šá€º á€›á€­á€¯á€€á€ºá€‘á€Šá€·á€ºá€•á€« á€žá€­á€¯á€·á€™á€Ÿá€¯á€á€º á€¡á€™á€Šá€º/á€–á€¯á€”á€ºá€¸á€–á€¼á€„á€·á€º á€›á€¾á€¬á€•á€«..." autocomplete="off"
                                ...
                                <button type="button" x-show="contactName" @click="contactName = ''; customerId = '';"
                                        class="absolute right-3 top-1/2 -translate-y-1/2 text-xs font-bold text-slate-400 hover:text-slate-600">âœ•</button>
                                        ...
                                        <button type="button" @click="selectCustomer(c)"
                                            ...
                                            <div>
                                                <div class="flex items-center gap-2">
                                                    ...
                                                    <span class="text-[10px] text-slate-400 font-mono" x-text="c.phone ? 'Â· ' + c.phone : ''"></span>
                                                </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3.5 pt-1">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute left-3.5 top-1/2 -translate-y-1/2 text-slate-400 text-xs">ðŸ“ž</span>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <span class="absolute left-3.5 top-3 text-slate-400 text-xs">ðŸ“</span>
                ...
                <div>
                    <div class="flex items-center gap-2.5 border-b border-slate-100 dark:border-slate-800 pb-3 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-[11px] text-slate-400">á€¡á€á€¼á€±á€¡á€”á€±áŠ á€á€¬á€á€”á€ºá€€á€»á€•á€Šá€¬á€›á€¾á€„á€ºá€”á€¾á€„á€·á€º á€€á€¼á€­á€¯á€á€„á€ºá€•á€±á€¸á€„á€½á€±</p>
                        </div>
                    </div>
                    ...
                    <div class="space-y-3.5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                            <div class="min-w-0">
                                <label class="block text-xs font-bold text-slate-600 dark:text-slate-400 mb-1">
                                    ðŸ“Š {{ __('messages.repair_current_status') }}
                                </label>
                            ...
                            <div class="min-w-0">
                                <label class="block text-xs font-bold text-slate-600 dark:text-slate-400 mb-1">
                                    ðŸ‘¨â€ðŸ”§ {{ __('messages.repair_technician') }}
                                </label>
                                <div class="flex items-center gap-1.5 min-w-0">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3.5 pt-1">
                            <div class="min-w-0">
                                <label class="block text-xs font-bold text-slate-600 dark:text-slate-400 mb-1">
                                    ðŸ’µ {{ __('messages.advance_payment') }}
                                </label>
                            ...
                            <div class="min-w-0">
                                ...
                                <select name="payment_method"
                                    ...
                                    <option value="cash">ðŸ’µ {{ __('messages.payment_cash') }}</option>
                                    <option value="kpay">ðŸ“± KBZPay</option>
                                    <option value="wavepay">ðŸ“± WavePay</option>
                                    <option value="cbpay">ðŸ¦ CB Pay / AYA Pay</option>
                                    <option value="mmqr">âš¡ MMQR / Transfer</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3.5 pt-1">
                            <div class="min-w-0">
                                <label class="block text-xs font-bold text-slate-600 dark:text-slate-400 mb-1">
                                    ðŸ’° {{ __('messages.repair_estimated_charge') }} ({{ $store->currency ?? 'MMK' }})
                                </label>
                            ...
                            <div class="min-w-0">
                                <label class="block text-xs font-bold text-slate-600 dark:text-slate-400 mb-1">
                                    ðŸ§¾ {{ __('messages.repair_voucher_no') }}
                                </label>
        ...
        <div class="rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 sm:p-6 shadow-sm space-y-5">
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="min-w-0">
                        <label class="block text-xs font-bold text-slate-600 dark:text-slate-400 mb-1">
                            ðŸ“± {{ __('messages.repair_model') }} <span class="text-rose-500">*</span>
                        </label>
                        <div class="flex items-center gap-1.5 min-w-0">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="min-w-0">
                        <label class="block text-xs font-bold text-slate-600 dark:text-slate-400 mb-1">
                            ðŸ”¢ {{ __('messages.repair_imei_serial') }}
                        </label>
                ...
                {{-- Row 4: Issue / Defect (á€–á€¯á€”á€ºá€¸á€–á€¼á€…á€ºá€á€»á€€á€º) --}}
                <div class="min-w-0">
                    <label class="block text-xs font-bold text-slate-600 dark:text-slate-400 mb-1">
                        âš¡ {{ __('messages.repair_defects') }} <span class="text-rose-500">*</span>
                    </label>
                ...
                {{-- Row 5: Accessories (á€–á€¯á€”á€ºá€¸á€”á€¾á€„á€·á€ºá€¡á€á€°á€‘á€¬á€¸á€á€²á€·á€žá€Šá€·á€ºá€•á€…á€¹á€…á€Šá€ºá€¸á€™á€»á€¬á€¸) --}}
                <div class="min-w-0">
                    <label class="block text-xs font-bold text-slate-600 dark:text-slate-400 mb-1">
                        ðŸ“¦ {{ __('messages.repair_accessories') }}
                    </label>
                    <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 min-w-0">
                ...
                <div class="rounded-2xl bg-slate-50/80 dark:bg-slate-800/40 border border-slate-200/80 dark:border-slate-700/60 p-4 space-y-3.5">
                    <div class="flex items-center justify-between">
                        <span class="text-xs font-black text-slate-800 dark:text-slate-200 flex items-center gap-1.5">
                            ðŸ”’ {{ __('messages.security_password') }}
                        </span>
                        ...
                        <div class="flex flex-col sm:flex-row items-center gap-6 justify-center py-2">
                            ...
                            <div class="space-y-2 text-center sm:text-left">
                                ...
                                <div class="px-3.5 py-2 rounded-xl bg-slate-100 dark:bg-slate-800 text-sm font-mono font-bold text-violet-600 dark:text-violet-400 min-w-[160px]"
                                     x-text="patternSequence.length ? patternSequence.join(' â†’ ') : '{{ __('messages.repair_pattern_none') }}'"></div>
                    ...
                    <div>
                        <label class="block text-xs font-bold text-slate-600 dark:text-slate-400 mb-1">
                            ðŸ”‘ {{ __('messages.device_password') }}
                        </label>
                ...
                <div class="space-y-2.5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-12 gap-2.5 items-center p-3 rounded-2xl bg-slate-50 dark:bg-slate-800/60 border border-slate-200/80 dark:border-slate-700">
                            ...
                            <div class="sm:col-span-2">
                                <select :name="'items[' + i + '][item_type]'" x-model="item.item_type"
                                    ...
                                    <option value="part">ðŸ“¦ {{ __('messages.repair_item_part') }}</option>
                                    <option value="service">ðŸ› ï¸ {{ __('messages.repair_item_service') }}</option>
                                </select>
                            </div>
                    ...
                    <div class="flex items-center justify-between pt-2 px-2">
                        <button type="button" @click="useAsEstimate()"
                            ...
                            âš¡ {{ __('messages.repair_use_total_as_charge') }}
                        </button>
    ...
    <div x-show="customerModalOpen" x-cloak class="fixed inset-0 z-50 grid place-items-center p-4"
        ...
        <div class="relative w-full max-w-md rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 shadow-2xl space-y-4">
            <div class="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3">
                <div class="flex items-center gap-2.5">
                    <span class="w-8 h-8 rounded-xl bg-sky-50 dark:bg-sky-950/60 text-sky-600 dark:text-sky-400 grid place-items-center text-base font-bold">ðŸ‘¤</span>
                    <h3 class="text-base font-black text-slate-900 dark:text-white">{{ __('messages.create_new_customer') }}</h3>
                </div>
                <button type="button" @click="customerModalOpen = false" class="w-8 h-8 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-500 font-bold hover:bg-slate-200">âœ•</button>
            </div>
            ...
            <div class="space-y-3.5">
                ...
                <div>
                    ...
                    <select x-model="newCustomer.type"
                        ...
                        <option value="retail_customer">ðŸ›ï¸ {{ __('messages.customer_retail') }}</option>
                        <option value="wholesale_customer">ðŸ¢ {{ __('messages.customer_wholesale') }}</option>
                    </select>
                </div>
                ...
                <div class="flex gap-2.5 pt-2">
                    ...
                    <button type="button" @click="submitNewCustomer()" :disabled="customerModalBusy || !newCustomer.name.trim() || !newCustomer.phone.trim()"
                        ...
                        <span x-text="customerModalBusy ? '{{ __('messages.saving') }}' : 'âœ“ {{ __('messages.save') }}'"></span>
                    </button>
                </div>
            </div>
        </div>
    ...
    <div x-show="quickAddModalOpen" x-cloak class="fixed inset-0 z-50 grid place-items-center p-4"
        ...
        <div class="relative w-full max-w-sm rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-5 shadow-2xl space-y-4">
            <div class="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3">
                ...
                <button type="button" @click="quickAddModalOpen = false" class="w-8 h-8 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-500 font-bold hover:bg-slate-200">âœ•</button>
            </div>
