...
<div class="w-full space-y-2 sm:space-y-2.5"
    ...
    <header class="w-full flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2.5 bg-white dark:bg-slate-900 rounded-lg p-2.5 sm:p-3.5 border border-slate-200/80 dark:border-slate-800 shadow-2xs transition">
        <div class="flex items-center gap-2.5 min-w-0">
            <div class="min-w-0">
                <div class="inline-flex items-center gap-1.5 px-2 py-0.5 rounded bg-rose-50 text-rose-700 dark:bg-rose-950/60 dark:text-rose-300 text-[10px] sm:text-[11px] font-black uppercase tracking-wider border border-rose-100 dark:border-rose-900/60 mb-0.5">
                    <span>💳</span>
                    <span>{{ __('messages.sidebar_receivables') }}</span>
                    <span class="text-slate-400 dark:text-slate-500">·</span>
                    <span class="font-normal normal-case text-slate-500 dark:text-slate-400">Customer Debt & Ledger</span>
                </div>
