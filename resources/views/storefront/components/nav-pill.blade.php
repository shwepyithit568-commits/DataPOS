...
--}}
<nav aria-label="Storefront primary navigation" class="sf-primary-nav flex flex-wrap items-center justify-center gap-1.5 sm:gap-2 rounded-2xl border border-slate-200/80 bg-white p-1 text-sm font-extrabold">
