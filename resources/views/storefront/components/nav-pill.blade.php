{{--
  ...
  Uses the variables prepared by the storefront layout (shared scope):
  $homeUrl $productsUrl $glassFinderUrl $serviceTrackingUrl $howToOrderUrl
  $blogUrl $isHome $isProducts $isGlassFinder $isServiceTracking
  $isHowToOrder $isBlog $activeStoreContext
--}}
