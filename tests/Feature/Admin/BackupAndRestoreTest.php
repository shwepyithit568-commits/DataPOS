...
class BackupAndRestoreTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // Whole-database backup/restore is platform-level (the dump contains
        // every store's data), so these functional tests act as the owner.
    ...
    public function test_manager_cannot_access_backups_dashboard(): void
    {
    ...
    public function test_platform_owner_can_access_backups_dashboard(): void
    {
    ...
    public function test_platform_owner_can_create_backup(): void
    {
        $response = $this->actingAs($this->platformOwner)
    ...
    public function test_platform_owner_can_create_full_zip_backup(): void
    {
        $response = $this->actingAs($this->platformOwner)
            ->post("/store/{$this->store->slug}/admin/backups", [
                'format' => 'zip',
    ...
    public function test_platform_owner_can_download_and_delete_backup(): void
    {
        ...
        $delResponse = $this->actingAs($this->platformOwner)
    ...
    public function test_platform_owner_can_restore_from_file(): void
    {
        /** @var DatabaseBackupService $service */
        $service = app(DatabaseBackupService::class);
    ...
    public function test_platform_owner_can_restore_from_upload(): void
    {
