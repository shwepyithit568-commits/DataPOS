    ...
    public static function bootstrapDefaultRoles(Store $store): void
    {
        ...
        static::updateOrCreate(
            ...
            [
                ...
                'permissions' => [
                    ...
                    'spare_parts.update',
                    'spare_parts.edit',
                    'service_settings.view',
                    'service_settings.create',
        ...
        static::updateOrCreate(
            ...
            [
                ...
                'description' => 'Daily counter sales, phone repair intake & delivery, online order handling, customer payments, and receipts.',
                ...
                'permissions' => [
                    ...
                    'customers.edit',
                    'reports_sales.view',
                    // Service & Phone Repair Center (ဖုန်းပြင်ဆင်ရေး ဂျော့ခ်ျလက်ခံ/အပ်ဒိတ်နှင့် ပစ္စည်းစစ်ဆေးမှု)
                    'repairs.view',
                    'repairs.create',
                    'repairs.update',
                    'repairs.edit',
                    'spare_parts.view',
                    'reports_services.view',
                    // E-Commerce & Online Store Orders (အွန်လိုင်း အော်ဒါစီမံမှု)
                    'ecommerce_orders.view',
                    'ecommerce_orders.create',
                    'ecommerce_orders.update',
                    'ecommerce_orders.edit',
