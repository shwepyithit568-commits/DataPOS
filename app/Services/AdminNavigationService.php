            ...
            'store' => [
                ...
                [
                    ...
                    'children' => [
                        ...
                        [
                            'key' => 'commercial_tax',
                            'translation_key' => 'messages.sidebar_commercial_tax',
                            'route_name' => 'pos.reports.tax',
                            'required_permissions' => ['reports_sales.view', 'reports_sales.edit'],
                            'active_patterns' => [
                                'route:pos.reports.tax*',
                                'path:store/*/pos/reports/tax*',
                                'path:store/*/admin/reports/tax*',
                                'path:store/*/admin/reports/commercial-tax*',
                                'path:store/*/reports/tax*',
                            ],
                            'icon' => '<svg class="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1-2-1Z"/><path d="M16 8h-6a2 2 0 1 0 0 4h4a2 2 0 1 1 0 4H8"/><path d="M12 6v12"/></svg>',
                        ],
                        [
                        ...
                        [
                            ...
                            'active_patterns' => [
                                ...
                                'path:store/*/admin/reports/reconciliation*',
                                'path:store/*/reports/reconciliation*',
                            ],
                            'icon' => '<svg class="h-3.5 w-3.5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m16 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="m2 16 3-8 3 8c-.87.65-1.92 1-3 1s-2.13-.35-3-1Z"/><path d="M7 21h10"/><path d="M12 3v18"/><path d="M3 7h2c2 0 5-1 7-2 2 1 5 2 7 2h2"/></svg>',
                        ],
                    ],
