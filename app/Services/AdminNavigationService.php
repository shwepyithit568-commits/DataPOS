                ...
                [
                    ...
                    'children' => [
                        ...
                        [
                            ...
                            'required_roles' => ['store_owner'],
                            'required_permissions' => ['import_history.view', 'import_history.edit'],
                ...
                [
                    ...
                    'children' => [
                        ...
                        [
                            ...
                            'required_roles' => ['store_owner', 'store_manager'],
                            'required_permissions' => ['branches.view', 'branches.edit'],
                        ...
                        [
                            ...
                            'required_roles' => ['store_owner', 'store_manager'],
                            'required_permissions' => ['printers.view', 'printers.edit'],
                        ...
                        [
                            ...
                            'required_roles' => ['store_owner', 'store_manager'],
                            'required_permissions' => ['vouchers.view', 'vouchers.edit'],
                        ...
                        [
                            ...
                            'required_roles' => ['store_owner', 'store_manager'],
                            'required_permissions' => ['exchange_rates.view', 'exchange_rates.edit'],
