        ...
        DB::transaction(function () use ($store, $forceReset) {
            ...
            $defaults = [
                ...
                [
                    ...
                    'label_my'            => 'ဆားဗစ်အခြေအနေ စစ်ဆေးရန်',
                    'label_en'            => 'Service Tracking',
                    'label_zh_cn'         => '维修进度查询',
                    'icon_key'            => 'repair',
                    'destination_type'    => 'system',
