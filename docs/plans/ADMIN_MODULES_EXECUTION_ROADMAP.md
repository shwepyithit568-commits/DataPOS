...
Use [Admin UI/UX Standard Guide](../guides/ADMIN_UI_UX_STANDARD_GUIDE_v4_1.md) as the standard for pages touched during new work. Avoid full-site redesign until pilot workflow is stable.
